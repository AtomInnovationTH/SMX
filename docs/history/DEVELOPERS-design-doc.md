> ⚠️ **HISTORICAL — ARCHIVED DESIGN DOC.** This is the original combined design /
> build-roadmap document (AI-coder quick start, MVP spec, multi-phase roadmap, plus
> architecture notes). It is kept for provenance and design rationale. Parts are
